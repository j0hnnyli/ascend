...
export default function ShippingAndReturnPage(){
  return (
    <div className="max_width p-2 md:py-16 md:px-5 flex flex-col justify-center items-center">
      <RevealY className="font_crimson text-4xl tracking-widest">Shipping</RevealY>

      <RevealY className="mt-10 flex flex-col justify-center items-center w-[90%] md:w-[50%]">
      ...
      <RevealY className="font_crimson text-4xl tracking-widest">Returns</RevealY>
